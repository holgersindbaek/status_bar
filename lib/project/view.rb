module StatusBar
  class View < UIViewController
    ...
    attr_accessor :notice_view, :notice_label, :activity_view, :activity_spinner, :activity_label, :success_view, :success_image, :success_label, :error_view, :error_image, :error_label

    layout(self.view, :status_bar_view) do
      ap "layout"
